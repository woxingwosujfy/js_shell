...
function Combin_All() {
  ...
  ## 城城分现金(jd_city.js)
  export CITY_SHARECODES=$(combine_sub ForOtherCity "RtGKzu6kEw-jeNeaENw73x4aTHtnmBBm8KSerYO5pD1jnXS9hg@RtGKiarVGFDwIvfzQpx5mlnLn7PlHH-WBmLyPXQ4GKO_uHvx@RtGKk6ndHkPCIcbCZKhumm2vdM7DL5DWnLF4QTmGxh_ezmKF@XYHgyOSjSReqf4GTFdx_mnGTeu_gdHr-iPknY4CxfUkKuiI")
  ## 618动物联萌(jd_zoo.js)
