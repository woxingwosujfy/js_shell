...
function Combin_All() {
  ...
  ## 东东农场(jd_fruit.js)
  export FRUITSHARECODES=$(Combin_Sub ForOtherFruit "caaa869cc54644d8b7d2b4a5ec86cc9e")
  ## 东东萌宠(jd_pet.js)
  export PETSHARECODES=$(Combin_Sub ForOtherPet "MTAxODc2NTEzMjAwMDAwMDAxOTYxNDc3NQ==" "MTAxODc2NTEzMjAwMDAwMDAxOTYxNDc3NQ==")
  ## 种豆得豆(jd_plantBean.js)
  export PLANT_BEAN_SHARECODES=$(Combin_Sub ForOtherBean "4npkonnsy7xi2gjsfnnf4zdv3xoe7m7tmjt3udy" "4npkonnsy7xi2gjsfnnf4zdv3xoe7m7tmjt3udy")
  ## 东东工厂(jd_jdfactory.js)
  export DDFACTORY_SHARECODES=$(Combin_Sub ForOtherJdFactory "T0225KkcR0gf91LWdU-ilPQPdgCjVWnYaS5kRrbA" "T0225KkcR0gf91LWdU-ilPQPdgCjVWnYaS5kRrbA")
